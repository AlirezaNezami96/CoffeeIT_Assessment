...
import alireza.nezami.coffeeit_assessment.BuildConfig
...
class NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideCoffeeMachineService(
        retrofit: Retrofit
    ): CoffeeMachineService = retrofit.create(CoffeeMachineService::class.java)
